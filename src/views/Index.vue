    ...
    <div class="topBox">
      ...
      <div class="right">
        ...
        <div class="littleBox">
          <!-- 图标 -->
          <div class="icon"
               style="background:#6b5cb7">
            <img src="../assets/icon/icon3.png"
                 style="width:66%;height:1rem"
                 alt />
          </div>
          <!-- 文字 -->
          <div class="text">
          ...
          <el-table :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)"
            ...
            <el-table-column width="20%"
              ...
              <template slot-scope="props"
                        style="padding:0">
                <table class="detail"
                       style="width:100%;font-size: 0.43rem;"
                       cellspacing="0">
            ...
            <el-table-column label="明细"
                             prop="det"
                             width="30%">序号</el-table-column>
            <el-table-column label="过车时间"
                             prop="LCXX_GCSJ"
                             width="150%"></el-table-column>
            <el-table-column label="参测点"
                             prop="TCZ_MC"></el-table-column>
            <el-table-column label="序号（车号）"
                             prop="LCXX_HBWJXH"></el-table-column>
            <el-table-column label="车型"
                             prop="LCXX_KH"></el-table-column>
            <el-table-column label="辆数"
                             prop="LCXX_ZLS"></el-table-column>
            <el-table-column label="轴数"
                             prop="LCXX_ZZS"></el-table-column>
            <el-table-column label="车速"
                             prop="LCXX_PJSU"></el-table-column>
            <el-table-column label="环温"
                             prop="LCXX_HW"></el-table-column>
            <el-table-column label="左平均温升"
                             prop="LCXX_ZJWS_T1"></el-table-column>
            <el-table-column label="右平均温升"
                             prop="LCXX_YJWS_T1"></el-table-column>
            <el-table-column label="警报信息"
                             prop="LCXX_RZDJ"></el-table-column>
          </el-table>
        </div>
        <!-- 表格分页 -->
        <div class="page">
